...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-20 md:py-28 bg-[#f8f8f8] bg-dot-grid overflow-hidden">
      
      {/* Decorative arc - top left */}
      <div className="decorative-arc -left-40 top-20 w-[500px] h-[500px]"></div>
