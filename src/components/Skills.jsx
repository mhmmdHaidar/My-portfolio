...
export default function Skills() {
  ...
  return (
    <section id="skills" className="relative py-20 md:py-28 bg-[#f8f8f8] bg-dot-grid overflow-hidden">
      
      {/* Decorative arcs */}
      <div className="decorative-arc -left-60 top-10 w-[600px] h-[600px]"></div>
      <div className="decorative-arc -right-60 bottom-10 w-[600px] h-[600px]"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="w-12 h-[3px] bg-black mx-auto mt-4 mb-4"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {skillCategories.map((cat, cIdx) => (
            ...
            >
              <h3 className="text-lg font-bold text-black italic text-center mb-6">
                {cat.title}
              </h3>
                ...
                {cat.skills.slice(0, 6).map((skill, sIdx) => (
                  ...
                  >
                    ...
                    <img 
                      ...
                      alt={skill.name}
                      className="w-8 h-8 opacity-90 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300"
                      onError={(e) => {
                        e.target.style.display = 'none';
                        e.target.nextSibling.style.display = 'flex';
                      }}
                    />
                    <div className="hidden items-center justify-center w-8 h-8 rounded bg-gray-200 text-gray-500 text-xs font-bold">
                      {skill.name.charAt(0)}
                    </div>
                  </div>
                ))}
